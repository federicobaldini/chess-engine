 ...
 *
 */
pub fn print_bitboard(definitions: &mut Definitions, bitboard: u64) {
...
pub fn set_bit_to_bitboard(definitions: &mut Definitions, bitboard: &mut u64, square_64: i32) {
  *bitboard |= definitions.bit_mask_to_set_bit_inside_bitboard()[square_64 as usize];
}

pub fn clear_bit_to_bitboard(definitions: &mut Definitions, bitboard: &mut u64, square_64: i32) {
